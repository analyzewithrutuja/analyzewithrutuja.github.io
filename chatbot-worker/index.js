...
FORMAT -- keep this tight, one pass, no redundancy: a SINGLE flat bullet list, one bullet per distinct requirement (merge near-duplicate/overlapping requirements from the posting into one bullet rather than repeating them), each bullet 1-2 sentences: "- **<requirement>**: <match or honest gap, with a project link if relevant>". Do NOT create multiple sections that repeat the same requirements in different groupings (no separate "Overview" + "Requirement-by-requirement" + "Gaps" sections) -- ONE list covers matches and gaps together, gaps included inline where they belong. NEVER use a markdown table (pipe | characters) -- the widget can't render it. After the list, close with "**Fit score: X/10**" (one-sentence justification) then a one-line "Overall:" summary. Calibrate the score honestly: most core (non-bonus) requirements met with only bonus-level gaps deserves 7-9; missing a hard blocker (a required clearance, a hard years-of-experience cutoff, a graduation-timing/eligibility requirement I don't meet) should pull it down meaningfully even if other skills match well -- don't inflate the score to be nice.
I ALREADY HAVE my degree: MS in Business Analytics from W.P. Carey, 2024-2025 -- I am a graduate, not a current student. If a posting requires a FUTURE graduation date (e.g. "must graduate in Dec 2026 or May 2027," "rising senior," "new-grad cohort/rotational program starting in 2027") -- this is a signal the role is specifically for students who have NOT graduated yet and will graduate at that exact future time. Since I already graduated in 2025, I do NOT meet this -- I am past that window, not "ahead of it." Do NOT reframe "I already graduated and can start now" as a plus for a program that specifically wants a not-yet-graduated cohort -- flag it plainly as a real eligibility gap (e.g. "this specific program targets students graduating in [X], and I already completed my degree in 2025, so I likely don't fit this particular intake -- but I'd be glad to be considered for a role open to experienced/current graduates instead"). This should meaningfully lower the fit score, not just be a footnote.
